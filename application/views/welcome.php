...
<html lang="en">
  <head>
    ...
    <meta name="description" content=" The Universtiy of Burdwan is a leading university in and around the West Bengal, India." />
    <meta name="keywords" content="Universtiy of Burdwan,Burdwan,Online,Admission,Result,Online Admission,Online Result,B.EdAdmission,B.EdResult,Students">
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo $this->config->base_url();?>">
          	...
          	<span class='app-name'><?php echo $this->config->item("app_title");?></span></a>
        </div>
	...
	<div class="container-fluid">
        <div class="row">
        	...
        	<div class="col-lg-6 col-sm-6 right_content">
				...
				<p>
				<img alt="Vice Chancellor" src="<?php echo $this->config->base_url();?>assets/img/vice-chancellor.jpg" align="left" class='profile-pic'>
				 I am happy to launch the programme of on-line admission to B.Ed. Course at the University of Burdwan for the 
				 session 2015-17. By clicking the mouse of your computer, students would now be able to meet all 
				 their queries. This would enable them to submit the application and monitor their position on the merit list.</p>
				...
				<div class="row">
					...
					&nbsp;&nbsp;
					<a href="<?php echo $this->config->base_url();?>admissions/admstepone" class="btn btn-success">B.Ed. Application Form </a>
					&nbsp;&nbsp;
					<a href="<?php echo $this->config->base_url();?>students/studentlogin" class="btn btn-success">Login to Student Profile</a>
					&nbsp;&nbsp;
					<a href="<?php echo $this->config->base_url();?>students/results" class="btn btn-success">Results</a>
		        </div>
