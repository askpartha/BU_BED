        	...
        	<div class="col-lg-4 col-sm-4 login-container">
	            ...
	            <div class="box">
	                <?php echo form_open('students/studentlogin', array('id' => 'login_form'));?>
	                    ...
	                    <div class="content">
		                    ...
		                    <div class="btm-mrg-sm">	
								...
								<span><input class="btn btn-primary pull-right submitbtn btm" type="button" value="Sign In" id="login" /></span>
							</div>	
					...
					<?php echo form_open('users/forgot', array('id' => 'fotgot_form', 'style' => 'display:none;'));?>
						<span id="password_msg" class="password_msg"></span>
	                    ...
	                    <div class="content">
	                    	...
	                    	<div class="form-group">
	                    		...
	                    		<input type="text" class="col-sm-12 col-lg-8" name="pg_apl_mobile" id="pg_apl_mobile" maxlength="10">
	                    	</div>
	                    	<div class="btm-mrg-sm">
