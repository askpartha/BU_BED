...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12 data-content">
			...
			<h4 style="text-align: center">Provisional Rank List of Online Application For <?php echo admissionName();?>(<?php echo getCurrentSession();?>) in the Department of Education, B.U.</h4>
			<hr/>
			<div class="row">
				<div class="col-sm-5">
				...
				<div class="col-sm-7">
					...
					<div class="row" style="border-style: solid; border-width:1px; margin-bottom: 5px; margin-left: 5px;">
						<div class="col-sm-12">
				...
				<?php	
						...
						echo "<h4 align='center'> Result will be published on " . $apl_result_date . "</h4>";
					}
				?>
			</div>
		</div>
