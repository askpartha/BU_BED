    ...
    <div id="collapseZero" class="panel-collapse collapse">
	    <div class="panel-body">
			<ul class="nav nav-list">
				...
				<li><?php echo anchor('configs/methods', 'Methods', 'title="Methods"');?></li>
				<li><?php echo anchor('configs/methodsubjects', 'Method - Subject Assocoation', 'title="Method - Subject Assocoation"');?></li>
				<li><?php echo anchor('configs/elligibility', 'Elligibility', 'title="Elligibility"');?></li>
	...
	<div id="collapseThree" class="panel-collapse collapse">
    	<div class="panel-body">
			<ul class="nav nav-list">
				...
				<li><?php echo anchor('reports/notifications/AGFTYUIJJDPJJDKLLDJJHGGGGD', 'Notifications', 'title="Notifications"');?></li>
				
				<!--
				<li><?php echo anchor('reports/formfillup', 'Form Fill-up', 'title="Form Fill-up"');?></li>
								<li><?php echo anchor('reports/challans', 'Challans', 'title="Challans"');?></li>-->
